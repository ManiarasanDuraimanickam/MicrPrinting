...
class printpage implements Printable {
	...
	printpage(String sideaddress1, String sideaddress2, String centeraddress1, String centeraddress2,
			String centeraddress3, String centeraddress4, String nofrom, String numto, String bankcode,
			String bankcode1, String bankcode2, String sidelength, String sideheight, String sidespace,
			String centerlength, String centerheight, String centerspace, String chequeNumlen, String chequeNumheg,
			URL urlimage1, URL urlimage2) {
	...
	public int print(Graphics g, PageFormat pf, int pageindex) {
		...
		g.drawString(this.bank_code1, micr_x6, micrstart_y);
		...
		g.drawString(this.bank_code1, micr_x6, micrstart_y2);
		...
		g.drawString(this.bank_code1, micr_x6, micrstart_y3);
